...
-- CreateTable
CREATE TABLE "OutboundClinic" (
    "outboundId" TEXT NOT NULL,
    "clinicId" TEXT NOT NULL,
    "assignedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "OutboundClinic_pkey" PRIMARY KEY ("outboundId","clinicId")
);
...
-- CreateIndex
CREATE INDEX "Outbound_userId_idx" ON "Outbound"("userId");

-- CreateIndex
CREATE INDEX "Clinic_nome_idx" ON "Clinic"("nome");

-- CreateIndex
CREATE INDEX "OutboundClinic_outboundId_idx" ON "OutboundClinic"("outboundId");

-- CreateIndex
CREATE INDEX "OutboundClinic_clinicId_idx" ON "OutboundClinic"("clinicId");
...
-- AddForeignKey
ALTER TABLE "OutboundClinic" ADD CONSTRAINT "OutboundClinic_outboundId_fkey" FOREIGN KEY ("outboundId") REFERENCES "Outbound"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "OutboundClinic" ADD CONSTRAINT "OutboundClinic_clinicId_fkey" FOREIGN KEY ("clinicId") REFERENCES "Clinic"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContactInteraction" ADD CONSTRAINT "ContactInteraction_outboundId_fkey" FOREIGN KEY ("outboundId") REFERENCES "Outbound"("id") ON DELETE CASCADE ON UPDATE CASCADE;
